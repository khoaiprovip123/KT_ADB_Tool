...
export const XIAOMI_EXPERIENCE_ITEMS: XiaomiExperienceItem[] = [
  ...
  },
  {
    ...
    readCommand: { namespace: "system", key: "pointer_location" },
    enableCommand: "settings put system pointer_location 1",
    disableCommand: "settings put system pointer_location 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
  {
  ...
  },
  {
    ...
    readCommand: { namespace: "global", key: "low_power" },
    enableCommand: "settings put global low_power 1",
    disableCommand: "settings put global low_power 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
  {
    ...
    detectStrategy: {
      brand: ["XIAOMI", "REDMI", "POCO"],
      minSdk: 29,
      settingsKeys: [{ namespace: "system", key: "dc_back_light" }],
    },
    readCommand: { namespace: "system", key: "dc_back_light" },
    enableCommand: "settings put system dc_back_light 1",
    disableCommand: "settings put system dc_back_light 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
];
