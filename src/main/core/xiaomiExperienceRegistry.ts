...
export const XIAOMI_EXPERIENCE_ITEMS: XiaomiExperienceItem[] = [
  // 1. Hiển thị & Màn hình
  {
    ...
    enableCommand: "settings put global show_refresh_rate 1 && settings put system show_refresh_rate 1",
    disableCommand: "settings put global show_refresh_rate 0 && settings put system show_refresh_rate 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
  {
  ...
  },
  {
    ...
    enableCommand: "settings put system reading_mode_status 1 && settings put system screen_paper_mode 1",
    disableCommand: "settings put system reading_mode_status 0 && settings put system screen_paper_mode 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
  {
  ...
  // 2. Cảm ứng & Điều hướng
  {
    ...
    enableCommand: "settings put secure long_press_timeout 250",
  ...
  // 3. Launcher & Recent Apps
  {
    ...
    enableCommand: "settings put secure recents_blur 1 && settings put secure recents_thumbnail_blur 1 && settings put secure miui_recents_blur_enabled 1",
    disableCommand: "settings put secure recents_blur 0 && settings put secure recents_thumbnail_blur 0 && settings put secure miui_recents_blur_enabled 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
  {
    ...
    enableCommand: "settings put global meminfo_show_swap 1 && settings put system show_memory_info 1",
    disableCommand: "settings put global meminfo_show_swap 0 && settings put system show_memory_info 0",
    defaultValue: "0",
    activeValues: ["1"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Chuyển đổi giao diện màn hình Đa nhiệm (Recent Apps) sang dạng xếp chồng (Stack style) mượt mà như iOS (Lưu ý: Có thể yêu cầu root/launcher tương thích trên một số ROM).",
    category: "launcher",
    risk: "SAFE",
    detectStrategy: {
      brand: ["XIAOMI", "REDMI", "POCO"],
  ...
  },
  {
    ...
    enableCommand: "settings put global power_mode 2 && settings put system high_performance_mode 1",
    disableCommand: "settings put global power_mode 0 && settings put system high_performance_mode 0",
    defaultValue: "0",
    activeValues: ["2"],
  },
  ...
  // 6. Quảng cáo & Gợi ý (Ads & Recommendation Removal)
  {
    ...
    enableCommand: "pm uninstall -k --user 0 com.miui.systemAdSolution || pm disable-user --user 0 com.miui.systemAdSolution",
  ...
  },
  {
    ...
    enableCommand: "pm disable-user --user 0 com.miui.daemon || pm uninstall -k --user 0 com.miui.daemon",
    disableCommand: "pm enable com.miui.daemon || pm install-existing --user 0 com.miui.daemon",
    defaultValue: "1",
    activeValues: ["0"],
  },
  {
