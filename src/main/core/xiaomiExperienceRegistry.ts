export interface XiaomiExperienceItem {
  ...
  detectStrategy: {
    ...
    minSdk?: number
    packages?: string[]
    settingsKeys?: Array<{ namespace: 'system' | 'secure' | 'global'; key: string }>
  }
...
export const XIAOMI_EXPERIENCE_ITEMS: XiaomiExperienceItem[] = [
  ...
  },
  {
    ...
    enableCommand: 'settings put global window_animation_scale 0.5 && settings put global transition_animation_scale 0.5 && settings put global animator_duration_scale 0.5',
    disableCommand: 'settings put global window_animation_scale 1.0 && settings put global transition_animation_scale 1.0 && settings put global animator_duration_scale 1.0',
    defaultValue: '1.0',
    activeValues: ['0.5']
  },
