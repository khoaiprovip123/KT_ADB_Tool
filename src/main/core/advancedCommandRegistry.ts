...
export const ADVANCED_COMMANDS: AdvancedCommandDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Xem chi tiết đường dẫn cài đặt, phiên bản, quyền hạn và chữ ký số của gói ứng dụng.",
    category: "diagnostics",
    risk: "SAFE",
    mode: "READ_ONLY",
  ...
  // ── APPOPS MANAGER ────────────────────────────────────────────────────────
  {
    ...
    description:
      "Đọc chi tiết các quyền can thiệp ẩn của gói ứng dụng được chọn.",
    category: "appops",
    risk: "SAFE",
    mode: "READ_ONLY",
  ...
  },
  {
    ...
    description:
      "Khôi phục ứng dụng về trạng thái mới cài đặt (Clear Data). Toàn bộ file và acc đăng nhập sẽ bị xóa.",
    category: "components",
    risk: "DANGEROUS",
    mode: "PACKAGE_OP",
