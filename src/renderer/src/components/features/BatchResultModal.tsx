          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-red-50 border border-red-100 p-4 rounded-2xl text-center">
                <div className="text-2xl font-black text-red-600 leading-none mb-1">
                  {result.fail}
                </div>
              ...
              <div className="bg-amber-50 border border-amber-100 p-4 rounded-2xl text-center">
                <div className="text-2xl font-black text-amber-600 leading-none mb-1">
                  {result.skipped}
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-sm mb-1 tracking-tight">
                      Gợi ý từ Chuyên gia (AI)
                    </h4>
                    <p className="text-xs text-blue-50/80 leading-relaxed font-medium">
                      Điện thoại chặn việc **Vô hiệu hóa** app này. Nhưng bạn
                      vẫn có thể gỡ nó bằng cách dùng nút **Thùng rác
                      (Uninstall)**.
                    </p>
