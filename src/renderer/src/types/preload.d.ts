...
export interface IADBAPI {
  ...
  renameFile: (deviceId: string, oldPath: string, newPath: string) => Promise<any>;
  pushFile: (deviceId: string, localPath: string, remotePath: string) => Promise<any>;
  pullFile: (deviceId: string, remotePath: string, localPath: string) => Promise<any>;
  ...
  debloatPackage: (deviceId: string, pkg: string, action: string, preferDisable: boolean) => Promise<any>;
  batchDebloat: (deviceId: string, packages: Array<{ package: string; preferDisable?: boolean }>, action: string) => Promise<any>;
  ...
  applyTweak: (deviceId: string, tweakId: string, enable: boolean) => Promise<any>;
