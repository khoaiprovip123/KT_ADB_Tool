        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-slate-400">
              Phiên bản hiện tại: 2.3.0-PRO-MAX
            </p>
          </div>
        </div>
        ...
        <div className="space-y-10 relative before:absolute before:inset-0 before:ml-6 before:h-full before:w-0.5 before:bg-slate-200/60">
            ...
            <div className="p-6 rounded-[2rem] bg-indigo-50/10 border border-indigo-100 shadow-lg shadow-indigo-900/5 group-hover:border-indigo-300 transition-colors relative overflow-hidden">
              ...
              <ul className="text-slate-500 text-sm font-bold space-y-3 relative z-10">
                ...
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Tối ưu hóa Xiaomi**: Hỗ trợ ép tần số quét màn hình (60/90/120/144Hz), bật FPS real-time, tăng tốc hoạt ảnh hệ thống, và bật chế độ toàn màn hình không viền cực kỳ mượt mà.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Mở rộng Whitelist ADB**: Cập nhật danh sách lệnh an toàn nâng cao với `pm enable`, `pm install-existing`, và `settings list` giúp chạy mượt mà không bị cảnh báo bảo mật.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-6 rounded-[2rem] bg-indigo-50/10 border border-indigo-100 shadow-lg shadow-indigo-900/5 group-hover:border-indigo-300 transition-colors relative overflow-hidden">
              ...
              <ul className="text-slate-500 text-sm font-bold space-y-3 relative z-10">
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Siêu Tối Ưu Hóa (Whitelisting)**: Mở khóa các quyền thực thi tối ưu nâng cao bao gồm tối ưu hóa Pin hệ thống (`cmd power set-mode`) và tăng luồng ưu tiên kết xuất SystemUI (`service call activity 134`) an toàn tuyệt đối.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Tự động Nhận diện IP LAN Pro**: Thuật toán mới nhận diện Wi-Fi LAN IP thông minh qua giao diện wlan0/wlan1, tự động lọc sạch các IP rác và IP mạng di động.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Dọn dẹp & Sửa lỗi ESLint**: Khắc phục triệt để 26 lỗi cú pháp, định dạng JSX và các khối catch trống, giúp mã nguồn nhẹ hơn và build mượt mà hơn.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-6 rounded-[2rem] bg-white border border-slate-200/60 shadow-lg shadow-blue-900/5 group-hover:border-blue-200 transition-colors">
              ...
              <ul className="text-slate-500 text-sm font-bold space-y-3 relative z-10">
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **File Manager Pro**: Ra mắt trình quản lý tệp tin Immersive
                    mới, hỗ trợ đầy đủ bộ nhớ trong và thẻ nhớ ngoài.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Image Preview Pro**: Xem ảnh 4K với chế độ Zoom & Pan mượt
                    mà bằng bánh xe chuột và kéo thả.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Tối ưu ADB**: Cải thiện cơ chế khởi tạo giúp ứng dụng mở
                    nhanh hơn và kết nối thiết bị ổn định hơn.
                  </span>
                </li>
                <li className="flex items-start gap-2.5 bg-white/60 p-2.5 rounded-xl border border-indigo-50">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_8px_rgba(79,70,229,0.5)]"></div>
                  <span>
                    **Giao diện Tinh tế**: Tăng độ tương phản chữ, gỡ bỏ các chỉ
                    dẫn rườm rà cho trải nghiệm tối giản.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="relative pl-14 group">
            ...
            <div className="p-6 rounded-[2rem] bg-white border border-slate-200/60 shadow-lg shadow-blue-900/5 group-hover:border-blue-200 transition-colors">
              <div className="flex items-center justify-between mb-4">
                <div className="font-black text-slate-800 text-xl tracking-tighter">
                  v2.0.0-PRO-MAX <span className="ml-2 text-blue-600">★</span>
                </div>
              ...
              <ul className="text-slate-500 text-sm font-medium space-y-2.5">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    Đột phá giao diện với phong cách **Light Glassmorphism** cao
                    cấp.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5 shrink-0"></div>
                  <span>
                    Tích hợp **Database Bloatware** thông minh
                    (Xiaomi/Samsung/Google).
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5 shrink-0"></div>
                  <span>
                    Nâng cấp **Thanh Thao tác (Selection Bar)** hỗ trợ xử lý
                    hàng loạt siêu tốc.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5 shrink-0"></div>
                  <span>
                    Cải tiến bộ lọc tìm kiếm với cơ chế **Debounce 300ms** mượt
                    mà.
                  </span>
                </li>
              </ul>
          ...
          <div className="relative pl-14 group opacity-70 hover:opacity-100 transition-opacity">
            ...
            <div className="p-6 rounded-[2rem] bg-slate-50/50 border border-slate-200/60">
              <div className="flex items-center justify-between mb-4">
                ...
                <time className="text-xs text-slate-400 font-black uppercase tracking-widest">
                  01/05/2026
                </time>
              </div>
