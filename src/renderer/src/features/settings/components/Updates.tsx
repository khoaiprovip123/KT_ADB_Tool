...
const DEFAULT_RELEASE_HISTORY: ReleaseItem[] = [
  {
    ...
    date: "06/08/2026",
    highlights: [
      "🧪 [Bản Beta] Tích hợp quy chuẩn 100% Danh Mục Khối Lệnh AOSP & Xiaomi MIUI/HyperOS (Android 9–17 Specs).",
...
export default function Updates() {
  const [currentVersion, setCurrentVersion] = useState("v2.5.3-beta");
